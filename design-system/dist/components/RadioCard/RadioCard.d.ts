 ...
 */
export declare function RadioCard({ value, selected, disabled, leading, title, badge, meta, metaMono, children, className, "aria-label": ariaLabel, ...rest }: RadioCardProps): import("react").JSX.Element;
